...
const data = {
    ...
    대구광역시: {
        ...
        동구: [
            ...
            "안심2동",
            "안심1동",
            "해안동[방촌동(1통), 부동, 둔산동 제외]",
            "공산동(지묘동,백안동,내동,팔공산지구만 수거)",
            "방촌동",
            "동촌동",
            "지저동",
            "불로봉무동",
        ...
        달서구: [
            "장기동+용산동+이곡동+신당동 전역+본리동+감삼동+죽전동 일부",
            "월성동+진천동+유천동+상인2동+도원동+송현2동+본동 전역+상인1동 일부",
            "성당동+두류동+상인3동+송현1동 전역+본리동+감삼동+죽전동+상인1동 일부",
            ...
            "두류동+감삼동+신당동",
            "성당동+본리동+죽전동(감삼동1~100번지 포함)+장기동+용산동+이곡동",
            "진천동+상인동+대곡동+송현1동",
            "월성동+유천동+도원동+송현2동+본동",
            "성당동+두류동+본리동+감삼동+죽전동+장기동+용산동+이곡동+신당동",
            "월성동+진천동+유천동+상인동+도원동+송현동+본동",
        ],
        중구: [
            "동인동",
            "삼덕동",
    ...
    부산광역시: {
        사상구: [
            "삼락동/모라1.3동/덕포1.2동/괘법동",
            "감전동/주례1.2.3동/학장동/엄궁동",
        ],
        연제구: ["연제구"],
        기장군: [
            "기장읍(동부리, 서부리, 대라리, 만화리, 교리, 신천리, 청강리, 시랑리, 연화리, 대변리, 죽성리, 당사리, 석산리, 내리, 와여리), 철마면(와여리, 장전리, 구칠리, 연구리, 고촌리, 송정리, 백길리, 웅천리, 이곡리) 제외 (타종수거)",
            "장안읍(좌천리, 기룡리, 장안리, 길천리, 임랑리, 오리, 반룡리), 일광면(학리, 삼성리, 이천리, 동백리,시녕리, 칠암리, 문중리, 문동리, 원리), 정관읍(방곡리, 매학리, 달산리, 모전리, 용수리, 예림리, 병산리, 정관지방산업단지)제외 타종수거",
            "기장읍(동부리, 서부리, 대라리, 만화리, 교리, 신천리, 청강리, 시랑리, 연화리, 대변리, 죽성리, 당사리, 석산리, 내리, 와여리), 철마면(와여리, 장전리, 구칠리, 연구리, 고촌리, 송정리, 백길리, 웅천리, 이곡리)",
            "장안읍(좌천리, 기룡리, 장안리, 길천리, 임랑리, 오리, 반룡리), 일광면(학리, 삼성리, 이천리, 동백리,시녕리, 칠암리, 문중리, 문동리, 원리), 정관읍(방곡리, 매학리, 달산리, 모전리, 용수리, 예림리, 병산리, 정관지방산업단지)",
        ],
        영도구: [
            "봉래2동+청학1·2동+동삼1·2·3동+태종대 유원지내 일반주택",
            "남항동+영선1·2동+신선동+봉래1동 일반주택",
            "일반주택B구역 내 공동주택※ 제외 : 청학2동 공동주택, 동삼1동 8개 공동주택(조양비치+함지그린+도개공 영구임대1·2지구+국제마마+반도보라+벽산+롯데캐슬)",
            "일반주택 A구역 내 공동주택+청학2동 공동주택+동삼1동 8개 공동주택(조양비치, 함지그린, 도개공 영구임대 1·2지구, 국제마마, 반도보라, 벽산, 롯데캐슬)",
        ],
        부산진구: [
            "부전1ㆍ2동, 연지동, 초읍동, 부암1ㆍ3동, 당감1ㆍ2ㆍ4동, 개금3동",
            "양정1ㆍ2동, 전포1ㆍ2동, 가야1ㆍ2동, 개금1ㆍ2동, 범천1ㆍ2동",
        ],
        금정구: [
            "서동+선두구동+남산동",
            "장전동+청룡노포동+구서동+금성동",
        ...
        강서구: [
            "대저1동 + 대저2동 + 강동동",
            "명지1동 + 명지2동 + 가락동 + 녹산동 + 가덕도동",
        ],
        북구: ["구포동+금곡동+화명동+덕천동+만덕동"],
        남구: [
            "대연1동+대연4동+대연5동+대연6동+문현동+용호1동 LG메트로1단지",
            "대연3동+용호동(LG메트로1단지 제외)+용당동+감만동+우암동",
        ],
        동래구: [
            "수민동, 복산동, 명륜동, 안락1동, 안락2동, 명장1동, 명장2동",
            "온천1동, 온천2동, 온천3동, 사직1동, 사직2동, 사직3동",
        ],
        수영구: ["남천1,2동+광안1,2,3,4동+수영동+망미1,2동+민락동"],
        서구: [
            "초장동+남부민동+암남동",
            "동대신동+서대신동+부민(부용)동+아미동+충무동",
        ],
        사하구: [
            "신평2동, 장림1동, 감천 1~2동",
            "괴정4동, 당리동, 신평1동, 장림2동, 다대 1~2동",
            "괴정 1~3동, 하단 1~2동, 구평동",
        ],
    },
    인천: {
        ...
        강화군: ["1권역"],
        중구: ["1권역", "2권역"],
        연수구: ["연수구", "연수구", "연수구", "연수구", "연수구"],
        미추홀구: ["1권역", "2권역", "3권역", "4권역", "6권역", "5권역"],
        남동구: ["1권역", "2권역", "3권역", "4권역", "5권역", "6권역", "7권역"],
    },
    광주: {
        남구: ["광주광역시 남구"],
    },
    ...
    울산: {
        ...
        남구: [
            "신정1동+신정4동+달동+삼호동+옥동+야음장생포동+선암동",
            "신정2동+신정3동+신정5동+삼산동+무거동+대현동+수암동",
        ],
        북구: [
            "염포동",
            "양정동",
